...
aop_style <- function() {
  ...
  ggplot2::theme(
    ...
    plot.title = ggtext::element_markdown(
      lineheight = 1.5, family = font, size = 14, colour = "#323232"
      ),
    plot.subtitle = ggtext::element_markdown(
      lineheight = 1.5, colour = "#808080", family = font, size = 12,
      margin = margin(t = 0., r = 0, b = 0.5, l = 0, unit = 'cm')
    ),
    plot.title.position = "plot",
    plot.caption = ggtext::element_markdown(
      lineheight = 1, family = font, size = 10, colour = "#808080", hjust = 0,
      margin = margin(t = 10)
      ),
    ...
    legend.title = ggtext::element_markdown(size = 10, colour = "#808080"),
    ...
    axis.text = element_markdown(size = 10, colour = '#808080'),
    ...
    strip.text = element_text(size = 10, face = "plain", colour = "#808080"),
